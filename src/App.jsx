    ...
    <div className="bg-slate-50 text-slate-800 min-h-screen font-sans">
      ...
      <nav className="bg-white text-slate-700 p-4 fixed w-full z-50 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          <a href="#hero" onClick={(e) => { e.preventDefault(); scrollToSection('hero'); }} className="text-2xl font-bold text-orange-500">iMate</a>
          ...
          <div className="md:hidden">
            <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="text-slate-700 focus:outline-none">
              {isMobileMenuOpen ? (
