  ...
  const faqData = [
    {
      ...
      answer: 'iMate는 이메일 자동 응답 및 분류, 고객 문의 초기 대응, 반복적인 정보 안내, CRM 데이터 자동 업데이트, 잠재고객 온보딩 메시지 발송, 콜드메일 개인화 및 발송 등 다양한 고객 커뮤니케이션 및 관리 업무를 자동화할 수 있습니다. 귀사의 특정 요구에 맞춰 기능을 커스터마이징할 수 있습니다.'
    },
    {
      question: '기존에 사용하던 CRM이나 다른 업무 도구와 연동이 가능한가요?',
      answer: '네, 가능합니다. iMate는 주요 CRM 시스템(예: Salesforce, HubSpot, Zapier 등) 및 다양한 업무 도구와의 유연한 연동을 지원합니다. API를 통한 맞춤 연동 개발도 가능하여, 기존 워크플로우에 자연스럽게 통합될 수 있습니다.'
    },
    {
      question: 'AI Agent 도입 비용과 예상 ROI는 어떻게 되나요?',
      answer: '도입 비용은 선택하시는 플랜과 필요한 AI Agent의 수, 커스터마이징 범위에 따라 달라집니다. 일반적으로 iMate 도입 후 인건비 절감, 업무 효율성 증대, 리드 전환율 향상 등을 통해 수개월 내에 ROI를 경험하실 수 있습니다. 자세한 내용은 요금제 섹션을 참고하시거나, 맞춤 상담을 통해 예상 ROI를 확인해보세요.'
    },
    {
      question: 'AI가 생성하는 답변의 품질은 어떻게 보장되나요?',
      answer: 'iMate의 AI Agent는 GPT-4 등 최신 언어 모델을 기반으로 하며, 귀사의 데이터를 학습하여 답변의 정확성과 관련성을 높입니다. 초기 설정 시 충분한 테스트와 검토 과정을 거치며, 지속적인 모니터링과 피드백을 통해 답변 품질을 개선해나갑니다.'
    },
    {
      question: '데이터 보안 및 개인정보보호는 어떻게 관리되나요?',
      answer: 'iMate는 고객 데이터를 최우선으로 생각하며, 강력한 보안 프로토콜과 암호화 기술을 적용하여 데이터를 안전하게 보호합니다. GDPR, CCPA 등 주요 개인정보보호 규정을 준수하며, 고객사와의 계약을 통해 데이터 처리 및 보안에 대한 책임을 명확히 합니다.'
    },
    {
      question: 'iMate 사용을 위한 교육이나 기술 지원이 제공되나요?',
      answer: '네, 제공됩니다. 초기 도입 시 담당자분들을 위한 상세한 사용 교육을 진행하며, 이해하기 쉬운 매뉴얼과 가이드 자료를 제공합니다. 또한, 운영 중 발생하는 문제나 궁금증에 대해 신속하게 대응할 수 있도록 이메일, 전화, 원격 지원 등 다양한 기술 지원 채널을 운영하고 있습니다.'
    }
  ];
