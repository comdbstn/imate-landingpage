        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-8 md:mb-12">
          ...
          >
            ...
            <ul className="space-y-2">
              <li><a href="#about" onClick={(e) => scrollToSection(e, 'about')} className="hover:text-orange-400 transition-colors duration-200">iMate 소개</a></li>
              <li><a href="#services" onClick={(e) => scrollToSection(e, 'services')} className="hover:text-orange-400 transition-colors duration-200">AI Agent 소개</a></li>
              <li><a href="#interactive-gpt" onClick={(e) => scrollToSection(e, 'interactive-gpt')} className="hover:text-orange-400 transition-colors duration-200">AI Agent 체험</a></li>
              <li><a href="#pricing" onClick={(e) => scrollToSection(e, 'pricing')} className="hover:text-orange-400 transition-colors duration-200">요금제</a></li>
              <li><a href="#faq" onClick={(e) => scrollToSection(e, 'faq')} className="hover:text-orange-400 transition-colors duration-200">FAQ</a></li>
            </ul>
          </div>
          ...
          >
            ...
            <ul className="space-y-2 text-slate-400">
              <li>Email: <a href="mailto:contact@imate.ai" className="text-slate-300 hover:text-orange-400 transition-colors duration-200">contact@imate.ai</a></li>
              <li>
                {/* Kakao Channel Link */}
                <div className="mt-2">
                  <a 
