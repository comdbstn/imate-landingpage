      ...
      <div className="container mx-auto px-6 md:px-12">
            ...
            >
              {plan.popular && (
                <div className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2">
                  <span className="bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">{plan.badgeText}</span>
                </div>
              )}
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-slate-600">
            ...
            두 플랜 모두 <a href="http://pf.kakao.com/_DcvJn/chat" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:text-orange-600 font-semibold transition-colors duration-200">카카오 채널 문의</a>를 통해 세부 사항을 조율하고 맞춤 견적을 받아보실 수 있습니다.
          </p>
        </div>
      </div>
    </section>
