  ...
  const testimonials = [
    {
      ...
      name: '김철수 대표',
      company: 'ABC커머스',
      avatar: 'https://via.placeholder.com/100/FF7F50/FFFFFF?Text=KCS' 
    },
    {
      quote: "신규 고객 온보딩 과정이 훨씬 체계적으로 자동화되어 만족도가 크게 향상되었습니다. 이전에는 담당자별로 안내 내용에 차이가 있었는데, iMate를 통해 일관된 고품질 정보를 제공할 수 있게 되었어요.",
      name: '이영희 마케팅 팀장',
      company: '주식회사 성장솔루션',
      avatar: 'https://via.placeholder.com/100/4682B4/FFFFFF?Text=LYH' 
    },
    {
      ...
      avatar: 'https://via.placeholder.com/100/32CD32/FFFFFF?Text=PJS' 
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-slate-700 italic text-base md:text-lg mb-0 flex-grow">
                "{testimonial.quote}"
              </p>
              {/* Avatar and name can be added back here if desired, ensure they also animate or are styled appropriately */}
              {/* 
              <div className="flex items-center mt-6 pt-4 border-t border-slate-200">
                <img 
